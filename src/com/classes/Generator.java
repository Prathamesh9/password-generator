...
public class Generator {
    ...
    public void mainLoop() {
        System.out.println("Welcome to Auto Password Services :)");
        printMenu();
    ...
    private void printUsefulInfo() {
        ...
        System.out.println("Include atleast one lowercase, uppercase characters, numbers and symbols");
        ...
        System.out.println("Do not use passwords which consist of any simple combination or weak components");
    }
    ...
    private void printMenu() {
        System.out.println();
        System.out.println("Select the corresponding option\n");
    ...
    private void printQuitMessage() {
    	System.out.println("Thank You for using the Password Generator Service!!");
